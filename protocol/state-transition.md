...
State transitions can alter the curves, affecting the effective leverage of derivative tokens, but they cannot change the value of existing positions in the pool. Effective leverage can only be reduced ([deleveraged](pricing.md)) and only for one side that is nearly out of reserve.
